...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 19206 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 876 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 30953 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 23635 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 26761 };
      job.tasks = [task];
      const employee: IEmployee = { id: 16107 };
      job.employee = employee;
