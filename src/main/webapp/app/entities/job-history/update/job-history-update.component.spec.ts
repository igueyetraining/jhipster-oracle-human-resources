...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 19270 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 583 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 14260 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 27528 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 9248 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 30811 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 7792 };
      jobHistory.job = job;
      const department: IDepartment = { id: 14742 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 28094 };
      jobHistory.employee = employee;
